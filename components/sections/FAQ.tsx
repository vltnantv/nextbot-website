...
const FAQ_DATA: FAQData[] = [
  ...
  // КАТЕГОРИЯ 4: Цена и договор
  {
    id: "q11",
    category: "pricing",
    question: "Наистина ли е безплатно в началото?",
    answer:
      "Да, напълно. 30 дни, реален бот, реални гости, нула разходи. Не искаме кредитна карта дори. Философията ни: ако не докажем стойност за 30 дни, не заслужаваме парите ви.",
  },
  {
    id: "q12",
    category: "pricing",
